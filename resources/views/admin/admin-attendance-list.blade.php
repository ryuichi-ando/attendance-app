                    ...
                    <tr class="table__row">
                        ...
                        <td class="table__description">
                            <p class="table__description--item">
                                {{ $attendance->start_time ? Carbon\Carbon::parse($attendance->start_time)->format('H:i') : '' }}</p>
                        </td>
                        <td class="table__description">
                            <p class="table__description--item">
                                {{ $attendance->end_time ? Carbon\Carbon::parse($attendance->end_time)->format('H:i') : '' }}</p>
                        </td>
                        <td class="table__description">
                            <p class="table__description--item">
                                {{ $attendance->total_break_time ? Carbon\Carbon::parse($attendance->total_break_time)->format('G:i') : '' }}
                            </p>
                        </td>
                        <td class="table__description">
                            <p class="table__description--item">
                                {{ $attendance->total_time ? Carbon\Carbon::parse($attendance->total_time)->format('G:i') : '' }}
                            </p>
                        </td>
                        <td class="table__description">
